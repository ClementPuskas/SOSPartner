 ...
 */
final class Version20190524113213 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game DROP FOREIGN KEY FK_232B318C65A30881');
        $this->addSql('DROP INDEX IDX_232B318C65A30881 ON game');
        $this->addSql('ALTER TABLE game DROP user_list_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game ADD user_list_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE game ADD CONSTRAINT FK_232B318C65A30881 FOREIGN KEY (user_list_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_232B318C65A30881 ON game (user_list_id)');
    }
}
